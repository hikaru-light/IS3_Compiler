...
and trans_exp ast env = match ast with Id v -> env v
																		 ...
																		 (*課題1:b.Assignに対応するようにtrans_expに記述する必要があった。*)
